...
export default function Home() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      technologies: ["Jupyter Notebook", "Python", "Machine Learning", "NLP", "BERT", "DeBERTa-v3", "Flask", "Pandas", "NumPy"],
      demoUrl: "",
    },
  ]
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-geist bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="row-start-2 w-full flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-col justify-center items-center w-full gap-4">
            <p className="text-xl sm:text-5xl font-bold text-center">
    ...
    >
      ...
      This page is still a work in progress. I am constantly updating it with new projects and information.
    </Badge>
